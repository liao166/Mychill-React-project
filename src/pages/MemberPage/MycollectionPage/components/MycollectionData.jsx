...
function MycollectionData() {
    ...
    useEffect(() => {
        ...
        axios
            .get(`http://localhost:8080/member/myLikeSch/${page}`, {
    ...
    const handleDelete = (e) => {
        ...
        axios
            .delete(`http://localhost:8080/member/delmyLikeSch/${ids}`)
            .then(() => {
                alert("行程刪除成功！");
    ...
    return (
        <>
            <div className="text-end mb-3">
                <a href="/SchInfo" className="btn btn-primary editbtn text-white">
                    新增行程 <b>＋</b>
                </a>
                {schedules.length > 0 && (
                    <button
